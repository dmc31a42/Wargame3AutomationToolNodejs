...
function checkWargame3Receive(data, context){
    ...
    var commandCode = [
        ...
        {code: 0xC1, class: Steel_C1_Send, modifyFunction:function(protocol){
            var wargame3Protocol = new Wargame3_C1_Send();
            wargame3Protocol.CommandCode = protocol.CommandCode;
            wargame3Protocol.UserSessionId = protocol.UserSessionId;
            wargame3Protocol.Unknown1 = 0;
            wargame3Protocol.ClientObsMod = protocol.ClientObsMod;
            return [wargame3Protocol];
        }},
        {code: 0xC8, class: Steel_C8_Send, preFunction:function(protocol){       
            if(protocol.UnknownMod==0){
                C8_EugNetId = protocol.EugNetId;
                C8_PlayerNumber = protocol.EugNetId;
                if(context.user.EugNetId == protocol.EugNetId) {
                    context.user.PlayerNumber = protocol.PlayerNumber; 
                }
            }
            return protocol;
        }, modifyFunction:function(protocol){
            var wargame3Protocol = new Wargame3_C8_Send();
            wargame3Protocol.CommandCode = protocol.CommandCode;
            wargame3Protocol.UnknownMod = protocol.UnknownMod;
            wargame3Protocol.Unknown1 = protocol.Unknown1;
            wargame3Protocol.EugNetId = protocol.EugNetId;
            wargame3Protocol.PlayerNumber = protocol.PlayerNumber;
            wargame3Protocol.Unknown2 = 1;
            return [wargame3Protocol];
        }},
        {code: 0xC9, class: Wargame3_C9_Send, modifyFunction:function(protocol){
            switch(protocol.Property){
                case "AllowObservers":
                case "ObserverDelay":
                case "TickRate":
                ...
                case "ModList":
                    return [];
                case "NbPlayersAndIA":
                    protocol.Property = "NbPlayer";
                    return [protocol];
                case "MaxTeamSize":
                    var nationConstraintProtocol = new Wargame3_C9_Send();
                    nationConstraintProtocol.CommandCode = 0xC9;
                    nationConstraintProtocol.Property = "NationConstraint";
                    nationConstraintProtocol.Value = "-1";
                    var thematicConstraint = new Wargame3_C9_Send();
                    thematicConstraint.CommandCode = 0xC9;
                    thematicConstraint.Property = "ThematicConstraint";
                    thematicConstraint.Value = "-1";
                    var dateConstraint = new Wargame3_C9_Send();
                    dateConstraint.CommandCode = 0xC9;
                    dateConstraint.Property = "DateConstraint";
                    dateConstraint.Value = "-1";
                    return [protocol, nationConstraintProtocol, thematicConstraint, dateConstraint];
                case "PlayerDeckContent":
                    var playerDeckName = new Wargame3_C9_Send();
                    playerDeckName.CommandCode = 0xC9;
                    playerDeckName.Property = "PlayerDeckName";
                    playerDeckName.Value = "";
                    var wargame3_C8_CAEnd = new Wargame3_C8_Send();
                    wargame3_C8_CAEnd.CommandCode = 0xC8;
                    wargame3_C8_CAEnd.UnknownMod = 1;
                    wargame3_C8_CAEnd.Unknown1 = 0;
                    wargame3_C8_CAEnd.EugNetId = C8_EugNetId;
                    wargame3_C8_CAEnd.PlayerNumber = C8_PlayerNumber;
                    wargame3_C8_CAEnd.Unknown2 = 0;
                    return [playerDeckName, protocol, wargame3_C8_CAEnd];
                default:
                    return [protocol];
            }
        }}
...
function checkWargame3Send(data, context){
    var commandCode = [
        ...
        {code: 0xC1, class: Wargame3_C1_Receive, preFunction:function(protocol){
            ...
            //     protocol.Unknown3 = 2;
            // }
            var steelProtocol = new Steel_C1_Receive();
            steelProtocol.CommandCode = protocol.CommandCode;
            steelProtocol.Unknown1 = protocol.Unknown1;
            steelProtocol.EugNetId = protocol.EugNetId;
            steelProtocol.Unknown2 = protocol.Unknown2;
            steelProtocol.VersionLen = protocol.VersionLen;
            steelProtocol.Version = protocol.Version;
            //steelProtocol.Unknown3 = protocol.Unknown3;
            steelProtocol.Unknown3 = 0x01;
            steelProtocol.PlayerNameLen = protocol.PlayerNameLen;
            steelProtocol.PlayerName = protocol.PlayerName;
            return [steelProtocol];
        }} // Player->Proxy->Dedicated
    ];
    var pos = 0;
    var buffers = [];
