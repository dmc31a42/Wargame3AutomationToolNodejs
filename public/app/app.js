...
app.run(['socket','$rootScope','uiSortableMultiSelectionMethods','$interval','$timeout','$state', '$cookieStore',
  function(socket, $rootScope, uiSortableMultiSelectionMethods, $interval, $timeout, $state, $cookieStore){
