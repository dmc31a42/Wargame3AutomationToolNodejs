...
var UdpProxy = function (options) {
    ...
    this._server.on('listening', function () {
        ...
        if (!client._bound) client.bind(0, proxyHost);
            ...
            console.log(msg);
            var wargame3Protocol = new Steel_UDP_Receive().FromBuffer(msg);
...
UdpProxy.prototype.createClient = function createClient(msg, sender) {
    ...
    client.once('listening', function () {
        ...
        console.log(msg);
        var steelProtocol = new Steel_UDP_Send().FromBuffer(msg);
        var wargame3Protocol = getWargame3_UDP_SendFromSteel_UDP_Send(steelProtocol);
        console.log(steelProtocol);
        console.log(wargame3Protocol);
