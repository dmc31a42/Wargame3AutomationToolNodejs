...
function checkWargame3Receive(data, context){
    var commandCode = [
        ...
        {code: 0xCA, class: Wargame3_CA_Send},
        {code: 0xC1, class: Steel_C1_Send},
        {code: 0xC8, class: Steel_C8_Send}
...
function checkWargame3Send(data, context){
    var commandCode = [
        ...
        {code: 0xC1, class: Steel_C1_Receive, preFunction:function(protocol){
            context.user = {
